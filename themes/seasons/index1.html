                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <img src="/assets/img/logo/Logo-Fundar.png" style="padding: 30px;" alt="Biblioteca">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <div class="slider-btns">
                                        <!-- Hero-btn -->
                                        <a data-animation="fadeInLeft" data-delay="1s" href="http://biblioteca.fundarlabs.mx/" class="btn radius-btn">Entrar</a>
                                    </div>
                                </div>
                            </div>
