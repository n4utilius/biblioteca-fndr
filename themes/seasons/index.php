                                ...
                                <div class="col-xl-5 col-lg-5 col-md-9 ">
                                    <div class="hero__caption">
                                        ...
                                        <div class="slider-btns">
                                            <!-- Hero-btn -->
                                            <a data-animation="fadeInLeft" data-delay="1s" id="mostrar_home" href="http://biblioteca.fundarlabs.mx/" class="btn radius-btn">Entrar</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6">
                                    <div class="hero__img d-none d-lg-block f-right">
                                        <img src="/themes/seasons/assets/img/hero/hero_gif-700px.gif" alt="" data-animation="fadeInRight" data-delay="1s">
                                    </div>
                                </div>
                            </div>
                        </div>
